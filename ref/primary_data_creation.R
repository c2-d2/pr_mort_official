...
write.csv(hh_main, "../data/cleaned_data/households.csv")
write.csv(individuals, "../data/cleaned_data/individuals.csv")
write.csv(deaths, "../data/cleaned_data/deaths.csv")
